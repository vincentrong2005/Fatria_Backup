...
export const ENEMY_DATABASE: Record<string, EnemyData> = {
  ...
  '伊甸·阿斯莫德': {
    ...
    stats: { 
      charm: 100, luck: 100, evasion: 50, crit: 50, willpower: 200, 
      sexPower: 100, baseEndurance: 90,
      maxEndurance: 300, maxPleasure: 200, maxClimaxCount: 5 
    },
  ...
  '白石响子': {
    ...
    stats: { 
      charm: 90, luck: 60, evasion: 20, crit: 15, willpower: 180,
      sexPower: 80, baseEndurance: 70,
      maxEndurance: 200, maxPleasure: 120, maxClimaxCount: 4 
    },
  ...
  '艾琳·海德': {
    ...
    stats: { 
      charm: 85, luck: 55, evasion: 22, crit: 18, willpower: 170,
      sexPower: 75, baseEndurance: 65,
      maxEndurance: 190, maxPleasure: 115, maxClimaxCount: 4 
    },
  ...
  '卡洛琳·兰德尔': {
    ...
    stats: { 
      charm: 75, luck: 50, evasion: 30, crit: 25, willpower: 160,
      sexPower: 70, baseEndurance: 60,
      maxEndurance: 180, maxPleasure: 110, maxClimaxCount: 3 
    },
  ...
  '蕾西·布莱克': {
    ...
    stats: { 
      charm: 70, luck: 60, evasion: 15, crit: 20, willpower: 150,
      sexPower: 65, baseEndurance: 55,
      maxEndurance: 170, maxPleasure: 105, maxClimaxCount: 3 
    },
  ...
  '米莉娅·格林伍德': {
    ...
    stats: { 
      charm: 75, luck: 55, evasion: 18, crit: 15, willpower: 145,
      sexPower: 60, baseEndurance: 50,
      maxEndurance: 165, maxPleasure: 100, maxClimaxCount: 3 
    },
  ...
  '塞西莉亚·罗森': {
    ...
    stats: { 
      charm: 80, luck: 65, evasion: 25, crit: 20, willpower: 165,
      sexPower: 70, baseEndurance: 60,
      maxEndurance: 175, maxPleasure: 110, maxClimaxCount: 3 
    },
  ...
  '莉莉安娜·蒙特古': {
    ...
    stats: { 
      charm: 70, luck: 50, evasion: 35, crit: 30, willpower: 170,
      sexPower: 75, baseEndurance: 65,
      maxEndurance: 200, maxPleasure: 120, maxClimaxCount: 4 
    },
  ...
  '索菲亚·克劳斯': {
    ...
    stats: { 
      charm: 95, luck: 80, evasion: 40, crit: 45, willpower: 190,
      sexPower: 85, baseEndurance: 75,
      maxEndurance: 250, maxPleasure: 150, maxClimaxCount: 5 
    },
  ...
  '克莱尔·温斯顿': {
    ...
    stats: { 
      charm: 60, luck: 55, evasion: 15, crit: 12, willpower: 140,
      sexPower: 55, baseEndurance: 45,
      maxEndurance: 160, maxPleasure: 100, maxClimaxCount: 3 
    },
  ...
  '伊莎贝拉·德雷克': {
    ...
    stats: { 
      charm: 95, luck: 75, evasion: 35, crit: 40, willpower: 200,
      sexPower: 80, baseEndurance: 70,
      maxEndurance: 220, maxPleasure: 140, maxClimaxCount: 4 
    },
  ...
  '艾米丽·布朗': {
    ...
    stats: { 
      charm: 70, luck: 50, evasion: 28, crit: 25, willpower: 155,
      sexPower: 65, baseEndurance: 55,
      maxEndurance: 170, maxPleasure: 105, maxClimaxCount: 3 
    },
