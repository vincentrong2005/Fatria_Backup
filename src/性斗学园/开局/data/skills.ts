...
export const STARTER_SKILLS: SkillData[] = [
  ...
  // === 魅惑之吻 ===
  {
    ...
    effectDescription: '造成500%魅力伤害，降低目标意志力10%持续2回合',
    icon: 'Heart',
    ...
    accuracy: 90,
    critModifier: 5,
    buffs: [{ type: BuffType.WILLPOWER_DOWN, value: -10, isPercent: true, duration: 2, stackable: false }],
    ignoreDefense: false,
    canBeDodged: true,
    canBeReflected: false,
    hitCount: 1,
    ...
    upgrades: [
      { cost: 1, damageIncrease: 10, costReduction: 0, cooldownReduction: 0 },
      { cost: 2, damageIncrease: 15, costReduction: 1, cooldownReduction: 0, specialEffect: '意志力降低+3%' },
  ...
  // === 快速反击 ===
  {
    ...
    effectDescription: '造成80%性斗力伤害，仅在使用后1回合内可用',
    icon: 'Shield',
    type: SkillType.PHYSICAL,
    rarity: SkillRarity.RARE,
    staminaCost: 15,
  ...
  // === 幸运一击 ===
  {
    ...
    castTime: 0,
    damageFormula: [
      { source: DamageSource.SEX_POWER, coefficient: 0.6 },
      { source: DamageSource.LUCK, coefficient: 0.4 },
    ],
    target: SkillTarget.SINGLE_ENEMY,
    accuracy: 75,
    critModifier: 10,
