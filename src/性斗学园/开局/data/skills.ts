...
export const STARTER_SKILLS: SkillData[] = [
  // === 衣物破坏 ===
  {
    ...
    effectDescription: '减少对方防御20%，持续整场战斗',
    icon: 'Scissors',
  ...
  // === 深吻 ===
  {
    ...
    effectDescription: '造成80%性斗力+30%魅力伤害，沉默1回合',
    icon: 'Kiss',
    type: SkillType.PHYSICAL,
    rarity: SkillRarity.COMMON,
    staminaCost: 12,
    ...
    damageFormula: [
      ...
      { source: DamageSource.CHARM, coefficient: 0.3, baseValue: 0 },
    ],
    target: SkillTarget.SINGLE_ENEMY,
    accuracy: 90,
    critModifier: 10,
  ...
  // === 污言秽语 ===
  {
    ...
    cooldown: 0,
    castTime: 0,
    damageFormula: [{ source: DamageSource.CHARM, coefficient: 0.5, baseValue: 3 }],
    target: SkillTarget.SINGLE_ENEMY,
    accuracy: 100,
    critModifier: 5,
  ...
  // === 费洛蒙 ===
  {
    ...
    cooldown: 5,
    castTime: 0,
    damageFormula: [{ source: DamageSource.CHARM, coefficient: 0.3, baseValue: 0 }],
  ...
  // === 偷拍视角 ===
  {
    ...
    cooldown: 5,
    castTime: 0,
    damageFormula: [{ source: DamageSource.CHARM, coefficient: 0.8, baseValue: 5 }],
    target: SkillTarget.SINGLE_ENEMY,
    accuracy: 90,
    critModifier: 0,
    buffs: [
  ...
  // === 露出 ===
  {
    ...
    cooldown: 2,
    castTime: 0,
    damageFormula: [{ source: DamageSource.CHARM, coefficient: 1.0, baseValue: 5 }],
    target: SkillTarget.SINGLE_ENEMY,
    accuracy: 95,
    critModifier: 20,
    buffs: [],
  ...
  // === 挑衅 ===
  {
    ...
    cooldown: 2,
    castTime: 0,
    damageFormula: [{ source: DamageSource.CHARM, coefficient: 0.3, baseValue: 2 }],
    target: SkillTarget.SINGLE_ENEMY,
    accuracy: 100,
    critModifier: 0,
    buffs: [
...
export const LUCK_SKILLS: SkillData[] = [
  {
    ...
    damageFormula: [
      ...
      { source: DamageSource.LUCK, coefficient: 0.8, baseValue: 0 },
    ],
    target: SkillTarget.SINGLE_ENEMY,
    accuracy: 85,
  ...
  },
  {
    ...
    damageFormula: [
      ...
      { source: DamageSource.LUCK, coefficient: 0.5, baseValue: 0 },
    ],
    target: SkillTarget.SINGLE_ENEMY,
    accuracy: 100,
    critModifier: 25,
...
export const ULTIMATE_SKILLS: SkillData[] = [
  ...
  },
  {
    ...
    damageFormula: [
      ...
      { source: DamageSource.CHARM, coefficient: 0.5, baseValue: 0 },
    ],
    target: SkillTarget.ALL_ENEMIES,
    accuracy: 100,
    critModifier: 0,
