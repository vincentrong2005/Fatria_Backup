...
export const STARTER_SKILLS: SkillData[] = [
  // === 衣物破坏 ===
  {
    ...
    effectDescription: '造成80%性斗力伤害，降低对方忍耐力15%',
    icon: 'Scissors',
    ...
    accuracy: 85,
    critModifier: 0,
    buffs: [{ type: BuffType.DEF_DOWN, value: -15, isPercent: true, duration: 99, stackable: true, maxStacks: 5 }],
    ignoreDefense: false,
    canBeDodged: true,
  ...
  // === 污言秽语 ===
  {
    ...
    effectDescription: '造成400%魅力伤害，降低意志力5%',
    icon: 'Comment',
  ...
  // === 偷拍视角 ===
  {
    ...
    effectDescription: '造成600%魅力伤害，降低意志力15%持续3回合',
    icon: 'Camera',
    type: SkillType.MENTAL,
    rarity: SkillRarity.RARE,
    staminaCost: 30,
    cooldown: 6,
    castTime: 0,
    damageFormula: [{ source: DamageSource.CHARM, coefficient: 6.0 }],
    target: SkillTarget.SINGLE_ENEMY,
    accuracy: 90,
    critModifier: 0,
    buffs: [{ type: BuffType.WILLPOWER_DOWN, value: -15, isPercent: true, duration: 3, stackable: false }],
    ignoreDefense: false,
    canBeDodged: true,
    canBeReflected: false,
    hitCount: 1,
  ...
  // === 束缚 ===
  {
    ...
    effectDescription: '造成40%性斗力伤害，束缚2回合，闪避-30%',
    icon: 'Chain',
  ...
  // === 露出 ===
  {
    ...
    effectDescription: '造成600%魅力伤害，对纯情角色必定暴击',
    icon: 'Sparkles',
  ...
  // === 强行压制 ===
  {
    ...
    effectDescription: '造成60%性斗力伤害，束缚2回合，闪避-50%',
    icon: 'Dumbbell',
    type: SkillType.CONTROL,
    rarity: SkillRarity.RARE,
    staminaCost: 20,
  ...
  // === 寸止 ===
  {
    ...
    effectDescription: '需快感>70%，造成40%目标快感伤害，降低意志力15%持续3回合',
    icon: 'HandFist',
    type: SkillType.CONTROL,
    ...
    cooldown: 7,
    castTime: 0,
    damageFormula: [{ source: DamageSource.TARGET_LUST, coefficient: 0.4 }],
    target: SkillTarget.SINGLE_ENEMY,
    accuracy: 100,
    critModifier: 0,
    buffs: [{ type: BuffType.WILLPOWER_DOWN, value: -15, isPercent: true, duration: 3, stackable: false }],
    ...
    upgrades: [
      ...
      { cost: 5, damageIncrease: 20, costReduction: 3, cooldownReduction: 1 },
      { cost: 6, damageIncrease: 25, costReduction: 4, cooldownReduction: 1 },
      { cost: 8, damageIncrease: 30, costReduction: 5, cooldownReduction: 2 },
    ],
    voiceLine: '还想高潮？太早了...',
  },
  // === 崇拜 ===
  ...
  // === 媚药投毒 ===
  {
    ...
    name: '媚药投毒',
    description: '【道具】悄悄下药',
    effectDescription: '降低意志力15%持续5回合',
    icon: 'Flask',
    type: SkillType.CONTROL,
    rarity: SkillRarity.EPIC,
    staminaCost: 30,
    ...
    accuracy: 85,
    critModifier: 0,
    buffs: [{ type: BuffType.WILLPOWER_DOWN, value: -15, isPercent: true, duration: 5, stackable: false }],
    ignoreDefense: false,
    canBeDodged: true,
    canBeReflected: false,
    hitCount: 0,
    unlockConditions: [],
    upgrades: [
      { cost: 3, damageIncrease: 0, costReduction: 0, cooldownReduction: 0 },
      { cost: 4, damageIncrease: 0, costReduction: 2, cooldownReduction: 0 },
      { cost: 5, damageIncrease: 0, costReduction: 3, cooldownReduction: 1 },
      { cost: 6, damageIncrease: 0, costReduction: 4, cooldownReduction: 1 },
      { cost: 8, damageIncrease: 0, costReduction: 5, cooldownReduction: 2 },
    ],
    voiceLine: '慢慢享受吧~',
  },
  // === 魅惑之吻 ===
  {
    ...
    effectDescription: '造成400%魅力伤害，降低目标意志力8%持续2回合',
    icon: 'Heart',
    type: SkillType.CHARM,
    rarity: SkillRarity.RARE,
    staminaCost: 23,
  ...
  // === 快速反击 ===
  {
    ...
    effectDescription: '造成60%性斗力伤害，仅在使用后1回合内可用',
    icon: 'Shield',
    type: SkillType.PHYSICAL,
    rarity: SkillRarity.RARE,
    staminaCost: 18,
...
export const PHYSICAL_SKILLS: SkillData[] = [
  ...
  // === 寸止 ===
  {
    ...
    effectDescription: '需对方快感>70%，造成50%目标快感伤害，降低意志力15%',
    icon: 'HandFist',
    type: SkillType.PHYSICAL,
    rarity: SkillRarity.EPIC,
    staminaCost: 20,
...
export const MENTAL_SKILLS: SkillData[] = [
  ...
  // === 嘲讽挑衅 ===
  {
    ...
    effectDescription: '造成300%魅力伤害，对方性斗力+20%但忍耐力-25%',
    icon: 'Ghost',
    type: SkillType.MENTAL,
    rarity: SkillRarity.COMMON,
    staminaCost: 8,
  ...
  // === 偷拍威胁 ===
  {
    ...
    effectDescription: '造成800%魅力伤害，降低意志力20%，恐惧2回合',
    icon: 'Camera',
    type: SkillType.MENTAL,
    rarity: SkillRarity.RARE,
    staminaCost: 15,
  ...
  // === 催眠暗示 ===
  {
    ...
    effectDescription: '造成60%意志力伤害，混乱3回合，降低意志力25%',
    icon: 'Disc',
    type: SkillType.MENTAL,
    rarity: SkillRarity.EPIC,
    staminaCost: 25,
