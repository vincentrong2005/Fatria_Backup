...
export const STARTER_SKILLS: SkillData[] = [
  // === 衣物破坏 ===
  {
    ...
    effectDescription: '造成40%性斗力伤害，降低对方忍耐力20%',
    icon: 'Scissors',
  ...
  // === 指尖挑逗 ===
  {
    ...
    effectDescription: '造成60%性斗力伤害，附加敏感状态',
    icon: 'HandPointer',
    type: SkillType.PHYSICAL,
    rarity: SkillRarity.COMMON,
    staminaCost: 8,
  ...
  // === 污言秽语 ===
  {
    ...
    cooldown: 0,
    castTime: 0,
    damageFormula: [{ source: DamageSource.CHARM, coefficient: 5.0 }],
    target: SkillTarget.SINGLE_ENEMY,
    accuracy: 100,
    critModifier: 5,
  ...
  // === 费洛蒙 ===
  {
    ...
    effectDescription: '造成300%魅力伤害，全体敌人发情状态',
    icon: 'Wind',
    ...
    cooldown: 5,
    castTime: 0,
    damageFormula: [{ source: DamageSource.CHARM, coefficient: 3.0 }],
  ...
  // === 偷拍视角 ===
  {
    ...
    effectDescription: '造成800%魅力伤害，降低意志20%，恐惧2回合',
    icon: 'Camera',
    type: SkillType.MENTAL,
    rarity: SkillRarity.RARE,
    staminaCost: 15,
  ...
  // === 足技 ===
  {
    ...
    cooldown: 1,
    castTime: 0,
    damageFormula: [{ source: DamageSource.SEX_POWER, coefficient: 0.7 }],
    target: SkillTarget.SINGLE_ENEMY,
    accuracy: 90,
    critModifier: 5,
  ...
  // === 露出 ===
  {
    ...
    effectDescription: '造成1000%魅力伤害，对纯情角色必定暴击',
    icon: 'Sparkles',
    ...
    cooldown: 2,
    castTime: 0,
    damageFormula: [{ source: DamageSource.CHARM, coefficient: 10.0 }],
    target: SkillTarget.SINGLE_ENEMY,
    accuracy: 95,
    critModifier: 20,
    buffs: [],
  ...
  // === 挑衅 ===
  {
    ...
    effectDescription: '造成300%魅力伤害，对方攻击+20%但防御-25%',
    icon: 'Grin',
    type: SkillType.MENTAL,
    rarity: SkillRarity.COMMON,
    staminaCost: 8,
  ...
  // === 强行压制 ===
  {
    ...
    effectDescription: '造成80%性斗力伤害，束缚2回合，闪避-50%',
    icon: 'Dumbbell',
    type: SkillType.CONTROL,
    rarity: SkillRarity.RARE,
    staminaCost: 25,
  ...
  // === 寸止 ===
  {
    ...
    effectDescription: '需快感>70%，造成50%目标快感伤害，意志-15%',
    icon: 'HandFist',
    type: SkillType.CONTROL,
  ...
  // === 催眠 ===
  {
    ...
    effectDescription: '造成60%意志力伤害，混乱3回合，意志-25%',
    icon: 'Disc',
    type: SkillType.MENTAL,
    rarity: SkillRarity.EPIC,
    staminaCost: 25,
    ...
    cooldown: 6,
    castTime: 1,
    damageFormula: [{ source: DamageSource.WILLPOWER, coefficient: 0.6 }],
    target: SkillTarget.SINGLE_ENEMY,
    accuracy: 70,
    critModifier: 0,
    buffs: [
...
export const PHYSICAL_SKILLS: SkillData[] = [
  ...
  },
  {
    ...
    effectDescription: '需对方快感>70%，造成50%目标快感伤害，降低意志15%',
    icon: 'HandFist',
    type: SkillType.PHYSICAL,
    rarity: SkillRarity.EPIC,
    staminaCost: 20,
...
export const MENTAL_SKILLS: SkillData[] = [
  ...
  },
  {
    ...
    effectDescription: '造成60%意志力伤害，混乱3回合，降低意志25%',
    icon: 'Disc',
    type: SkillType.MENTAL,
    rarity: SkillRarity.EPIC,
    staminaCost: 25,
...
export const CHARM_SKILLS: SkillData[] = [
  {
    ...
    effectDescription: '造成1000%魅力伤害，对纯情角色暴击',
    icon: 'Sparkles',
    type: SkillType.CHARM,
    rarity: SkillRarity.COMMON,
    staminaCost: 10,
  ...
  },
  {
    ...
    effectDescription: '造成300%魅力伤害，全体敌人发情状态4回合',
    icon: 'Wind',
    type: SkillType.CHARM,
    rarity: SkillRarity.RARE,
    staminaCost: 20,
  ...
  },
  {
    ...
    effectDescription: '造成800%魅力伤害，使对方进入魅惑状态2回合',
    icon: 'GrinHearts',
    type: SkillType.CHARM,
    rarity: SkillRarity.EPIC,
    staminaCost: 22,
...
export const ULTIMATE_SKILLS: SkillData[] = [
  ...
  },
  {
    ...
    effectDescription: '造成100%意志力伤害，全体敌人攻击/防御/意志各-25%',
    icon: 'Crown',
    type: SkillType.ULTIMATE,
    rarity: SkillRarity.LEGENDARY,
    staminaCost: 45,
    ...
    cooldown: 10,
    castTime: 0,
    damageFormula: [{ source: DamageSource.WILLPOWER, coefficient: 1.0 }],
    target: SkillTarget.ALL_ENEMIES,
    accuracy: 100,
    critModifier: 0,
    buffs: [
