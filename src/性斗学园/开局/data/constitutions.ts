...
export const COMMON_CONSTITUTIONS: ConstitutionData[] = [
  ...
  },
  {
    ...
    effectDescription: '魅力+30，性斗力成算+10%',
    icon: 'GrinHearts',
    category: ConstitutionCategory.SPECIAL,
    rarity: ConstitutionRarity.RARE,
    permanentModifiers: [
      { stat: '魅力加成', value: 30, isPercent: false },
      { stat: '基础性斗力成算', value: 10, isPercent: true },
    ],
    sensitivityModifiers: [],
    triggerEffects: [],
    genderRestriction: [],
  ...
  },
  {
    ...
    effectDescription: '性斗力成算+15%，忍耐力成算-10%',
    icon: 'Eye',
    category: ConstitutionCategory.TENDENCY,
    rarity: ConstitutionRarity.RARE,
    permanentModifiers: [
      { stat: '基础性斗力成算', value: 15, isPercent: true },
  ...
  },
  {
    ...
    effectDescription: '忍耐力成算+15%，性斗力成算+10%',
    icon: 'HeartBroken',
    category: ConstitutionCategory.TENDENCY,
    rarity: ConstitutionRarity.COMMON,
    permanentModifiers: [
  ...
  },
  {
    ...
    effectDescription: '暴击率+15%，性斗力成算+10%',
    icon: 'Crown',
    category: ConstitutionCategory.TENDENCY,
    rarity: ConstitutionRarity.COMMON,
    permanentModifiers: [
  ...
  },
  {
    ...
    effectDescription: '闪避率+10%，魅力+8，但性斗力成算-5%',
    icon: 'Shield',
    category: ConstitutionCategory.PHYSICAL,
    rarity: ConstitutionRarity.RARE,
    permanentModifiers: [
      { stat: '闪避率加成', value: 10, isPercent: true },
      { stat: '魅力加成', value: 8, isPercent: false },
  ...
  },
  {
    ...
    effectDescription: '性斗力成算+10%，幸运+12，但忍耐力成算-10%',
    icon: 'HeartPulse',
    category: ConstitutionCategory.SENSITIVITY,
    rarity: ConstitutionRarity.EPIC,
    permanentModifiers: [
      { stat: '基础性斗力成算', value: 10, isPercent: true },
      { stat: '幸运加成', value: 12, isPercent: false },
      { stat: '基础忍耐力成算', value: -10, isPercent: true },
    ],
    sensitivityModifiers: [],
    triggerEffects: [],
  ...
  },
  {
    ...
    effectDescription: '性斗力加成+8，忍耐力加成+8，但魅力-5',
    icon: 'Scale',
    category: ConstitutionCategory.SPECIAL,
    rarity: ConstitutionRarity.RARE,
    permanentModifiers: [
...
export const MALE_CONSTITUTIONS: ConstitutionData[] = [
  {
    ...
    effectDescription: '性斗力成算+25%，暴击率+10%',
    icon: 'Dumbbell',
    category: ConstitutionCategory.PHYSICAL,
    rarity: ConstitutionRarity.RARE,
    permanentModifiers: [
  ...
  },
  {
    ...
    effectDescription: '暴击率+20%，忍耐力成算-15%',
    icon: 'Target',
    category: ConstitutionCategory.SENSITIVITY,
    rarity: ConstitutionRarity.EPIC,
    permanentModifiers: [
  ...
  },
  {
    ...
    name: '无限子弹',
    description: '惊人的恢复能力',
    effectDescription: '忍耐力成算+20%，最大耐力+30',
    icon: 'Sync',
...
export const FEMALE_CONSTITUTIONS: ConstitutionData[] = [
  {
    ...
    name: '乳首开发',
    description: '胸部极为敏感',
    effectDescription: '闪避率+8%，忍耐力成算-10%',
    icon: 'Target',
    category: ConstitutionCategory.SENSITIVITY,
    rarity: ConstitutionRarity.RARE,
    permanentModifiers: [
  ...
  },
  {
    ...
    effectDescription: '魅力+20，性斗力成算+15%',
    icon: 'Water',
    category: ConstitutionCategory.SPECIAL,
    rarity: ConstitutionRarity.EPIC,
    permanentModifiers: [
