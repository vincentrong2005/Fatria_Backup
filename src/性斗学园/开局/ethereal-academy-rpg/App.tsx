        ...
        <div className="flex-1 flex flex-col relative">
          ...
          <div className="flex-1 p-6 md:p-10">
            ...
            <div className="max-w-2xl mx-auto min-h-[400px]">
              ...
              {step === 1 && (
                <Step1_Identity data={characterData} updateData={updateCharacterData} />
              )}
              {step === 2 && (
                <Step2_Archetype data={characterData} updateData={updateCharacterData} />
              )}
              {step === 3 && (
                <Step3_Attributes data={characterData} updateData={updateCharacterData} />
              )}
              {step === 4 && (
                <Step4_Skills data={characterData} updateData={updateCharacterData} />
              )}
            </div>
          </div>
