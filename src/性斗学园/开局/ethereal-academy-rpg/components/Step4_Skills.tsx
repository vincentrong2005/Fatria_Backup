        ...
        <div className="p-4 h-[300px] overflow-y-auto custom-scrollbar">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {ACTIVE_SKILLS.map((skill) => {
              ...
              return <SkillCard key={skill.id} skill={skill} isSelected={isSelected} isDisabled={isDisabled} onToggle={() => toggleActiveSkill(skill.id)} />;
            })}
          </div>
        </div>
      </div>
        ...
        <div className="p-4 h-[300px] overflow-y-auto custom-scrollbar">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {currentPassiveSkills.map((skill) => {
              ...
              return <SkillCard key={skill.id} skill={skill} isSelected={isSelected} isDisabled={isDisabled} onToggle={() => togglePassiveSkill(skill.id)} />;
            })}
          </div>
        </div>
      </div>
