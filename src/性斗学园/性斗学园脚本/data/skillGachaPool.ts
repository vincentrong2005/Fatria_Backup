...
export const A_RANK_SKILLS: GachaSkillData[] = [
  ...
  {
    id: 'g_a_splits_allure',
    name: '劈叉诱惑',
    description: '【魅力】展现柔韧的劈叉姿态，完全敞开身体最私密处',
    effectDescription: '造成460%魅力伤害，提升自身魅力30点持续2回合',
    icon: 'Expand',
    type: 'charm',
    rarity: 'A',
    staminaCost: 32,
...
export const S_RANK_SKILLS: GachaSkillData[] = [
  ...
  {
    id: 'g_s_deepthroat_allure',
    name: '深喉魅惑',
    description: '【魅力】以极致的口技展现臣服与诱惑的艺术',
    effectDescription: '造成590%魅力伤害，提升自身魅力48点持续3回合',
    icon: 'CircleDashed',
    type: 'charm',
    rarity: 'S',
    staminaCost: 42,
    ...
    critModifier: 20,
    hitCount: 1,
    buffs: [{ type: '魅力', value: 48, isPercent: false, duration: 3, isTargetEnemy: false }],
  },
  // S级幸运系新增技能
  {
