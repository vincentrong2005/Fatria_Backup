        ...
        <div class="help-body">
          ...
          <div class="help-section">
            ...
            <div class="help-text">
              ...
              <div>战斗判定（来自战斗计算）：</div>
              <div>- 闪避判定：最终命中率 = 技能命中率 - 目标闪避率 + (攻击者幸运/8)，并 clamp 到 10%..95%；随机 roll∈[0,100)，若 roll ≥ 最终命中率 则视为闪避成功。</div>
              <div>- 暴击判定：最终暴击率 = 攻击者暴击率 + (攻击者幸运/8) + 技能暴击修正，并 clamp 到 0%..100%；随机 roll∈[0,100)，若 roll &lt; 最终暴击率 则暴击。</div>
              <div>- 忍耐减伤：减伤后伤害 = floor( 基础伤害 × 40 / (目标忍耐力 + 100 + 5*max(0, 敌方等级 - 玩家等级)) )，最低为 1。</div>
            </div>
          </div>
