  ...
  const regions = [
    {
      name: '人类联合王国',
      children: [
        { name: '王都·艾伦', desc: '人类文明的绝对核心。城市围绕着巨大的地脉能源抽取设施而建，是王国的政治、经济、魔法与科技中心。', people: '奥古斯都三世, 玛奇玛, 索菲亚, 艾莉亚, 布里安娜, 菲欧娜, 莉安, 塞缪尔, 九尾, 铃兰, 芬里尔, 弥娅, 小桃', x: 50, y: 70 },
        { name: '王宫', desc: '位于王都·艾伦中心区域的宏伟宫殿，是人类联合王国的政治中心，国王奥古斯都三世的居所和行政中心。', people: '奥古斯都三世, 艾莉亚, 布里安娜, 菲欧娜, 莉安, 塞缪尔', x: 50, y: 70 },
        { name: '炼金协会总部（黑塞壬之塔）', desc: '位于王都·艾伦工业区核心的巨大黑色塔楼，是炼金协会的总部。塔周围的空气中弥漫着甜得发腻的人造草莓味，掩盖地下排放的化学废气和血腥味。', people: '玛奇玛', x: 40, y: 68 },
        { name: '白塔学院', desc: '位于王都·艾伦学者区"静谧之湖"中央的白色塔楼，是白塔学院的总部。这里的空气经过二十重过滤，带有陈旧羊皮纸和冷冽臭氧的气味。', people: '索菲亚, 菲欧娜', x: 64, y: 65 },
        { name: '冒险协会', desc: '位于王都·艾伦"自由市场区"的一号分会，是一栋用巨龙肋骨和沉船木料搭建的三层建筑，终年弥漫着烈酒、汗水和廉价脂粉的味道。', people: '艾莉亚, 布里安娜, 菲欧娜, 莉安, 塞缪尔', x: 58, y: 64 },
        { name: '外环区', desc: '王都·艾伦光鲜的内城城墙之外的贫民窟与旧街巷，潜藏着复杂的亚人地下网络。', people: '九尾, 铃兰, 芬里尔, 弥娅, 小桃', x: 32, y: 72 },
        { name: '亚人地下诊所', desc: '位于外环区，伪装成破旧药铺的地下诊所，由小桃等人负责为亚人、逃犯与无证居民提供最低限度却尽力负责的医疗服务。', people: '小桃, 弥娅, 九尾, 芬里尔, 铃兰', x: 30, y: 74 },
        { name: '地脉湖', desc: '位于人类联合王国内陆的巨大地脉湖，与人类的魔力管道系统相连。塞壬娅被困在此地，她的歌声能够与人类的魔力管道产生共振。', people: '塞壬娅', x: 61, y: 72 },
        { name: '钢铁要塞', desc: '位于王国北境的巨型军事要塞，是抵御魔族入侵的第一道也是最重要的一道防线。要塞本身即是一座巨大的战争机器。', people: '伊莎贝拉, 布里安娜, 塞缪尔, 艾莉亚', x: 48, y: 60 },
        { name: '港口城·潮汐之门', desc: '王国在南部海岸线上最大的港口城市，承担了超过九成的海上贸易与物资运输，同时也是王国海军的主基地。', people: '克拉拉, 菲雅', x: 30, y: 80 },
        { name: '巨石城', desc: '坐落于西部山脉脚下的矿业城市，为整个王国提供绝大部分的金属、煤炭和宝石资源，城市的运作围绕着巨大的矿井展开。', people: '卡珊德拉', x: 32, y: 62 },
        { name: '黄金平原', desc: '由王国南部众多农业城镇与村庄组成的广袤产粮区。这里出产的粮食供养着王国的军队与所有城市人口，是王国的生命线。', people: '无', x: 38, y: 76 },
        { name: '旧王都·晨星城遗址', desc: '上一个时代被魔族攻陷并摧毁的人类王都废墟。如今是一片充斥着亡灵与残余战争能量的危险区域。', people: '无', x: 62, y: 52 },
      ],
    },
    {
      name: '永恒战场',
      children: [
        { name: '叹息之墙', desc: '人类方沿着地脉枯竭区南缘建造的巨型防御工事，与后方的钢铁要塞相连，是人类防御体系的最北端。', people: '伊莎贝拉, 布里安娜, 塞缪尔', x: 50, y: 55 },
        { name: '魔牙壁垒', desc: '魔族在战场北缘建立的进攻性要塞群，由数座黑曜石堡垒组成，是魔王军发动大规模进攻的桥头堡。', people: '巴洛克', x: 50, y: 30 },
        { name: '无主之地', desc: '位于"叹息之墙"与"魔牙壁垒"之间的广阔缓冲地带。这里是斥候渗透、小队冲突和刺杀行动最频繁的区域，伤亡率极高。', people: '莉安, 塞勒涅', x: 50, y: 50 },
        { name: '骸骨之痕', desc: '一片散落着远古巨兽骸骨与古代战争机械残骸的区域。残存的能量和怨念吸引了大量无自主意识的魔物和亡灵在此徘徊。', people: '无', x: 62, y: 39 },
        { name: '枯萎地脉裂谷', desc: '大地上一道深不见底的巨大裂谷，是地脉能量彻底枯竭后留下的疤痕。谷底充斥着混乱的能量风暴和自发形成的元素生物。', people: '无', x: 45, y: 45 },
        { name: '寂静哨塔', desc: '散布在战场各处被废弃的观察哨塔。因其相对坚固的结构，偶尔会成为战场上的独行者们临时的避难所。', people: '无', x: 55, y: 42 },
        { name: '破碎平原', desc: '永恒战场的主体区域，一片南北宽度超过一百五十公里的广阔焦土。平原表面布满了无数弹坑、裂谷和能量结晶化的尖锐岩石，是双方争夺的主要战场。', people: '艾莉亚, 布里安娜, 菲欧娜, 莉安, 塞缪尔, 巴洛克', x: 50, y: 40 },
      ],
    },
    {
      name: '魔族领地',
      children: [
        { name: '魔王城·诺克萨斯', desc: '魔族的权力中心，由一整块黑曜石山峰雕刻而成的巨大堡垒。魔王的深渊王座位于其最深处。', people: '奈尔法, 阿兹莫, 塞勒涅', x: 50, y: 8 },
        { name: '血祭神庙', desc: '魔族用于进行血脉强化、力量转化和效忠仪式的场所。巨大的祭坛上燃烧着永不熄灭的魔力火焰。', people: '无', x: 35, y: 15 },
        { name: '孵化深渊', desc: '用于大规模培育新生代魔族士兵和战争巨兽的巨大生物巢穴。整个巢穴如同一个拥有自我意识的活体，内部充满了羊水般的营养液池。', people: '佩拉', x: 42, y: 21 },
        { name: '骸骨熔炉', desc: '处理战死者尸骸并将其能量与骨骼回收利用的巨型工厂。其产物（如骸骨士兵、骨质装甲）被直接输送到前线军队。', people: '无', x: 58, y: 20 },
        { name: '尖啸峡谷', desc: '位于数座火山之间、布满强对流气流的巨大峡谷。这里是魔族空军的巢穴和训练场。', people: '无', x: 62, y: 15 },
        { name: '遗忘监牢', desc: '用于囚禁魔族内部的叛徒、强大的战俘或危险实验体的地底监狱。每个牢房都设有针对性的封印结界。', people: '典狱长', x: 40, y: 13 },
      ],
    },
    {
      name: '东方精灵之森',
      children: [
        { name: '世界树·伊格德拉修', desc: '位于森林正中心，是整个森林的生命与魔力之源。精灵的文明完全围绕此树建立，其最高权力机构"精灵议会"的议事厅就位于世界树的顶端。', people: '艾拉瑞亚, 希尔薇, 莉安娜', x: 78, y: 20 },
        { name: '迷雾沼泽', desc: '环绕在森林最外围的天然屏障。沼泽中的浓雾附有强大的幻术效果，能让绝大多数入侵者迷失方向，最终无功而返。', people: '无', x: 79, y: 61 },
        { name: '古树哨兵防线', desc: '位于迷雾沼泽内侧的第二道防线。由无数拥有自我意识的巨大古树组成，它们会主动攻击任何未经许可的闯入者。', people: '莉安德拉, 凯兰崔尔', x: 71, y: 52 },
        { name: '月亮湖', desc: '一个由纯粹自然魔力汇集而成的湖泊。湖水拥有强大的治愈和净化能力，是精灵族举行重要仪式和疗伤的圣地。', people: '奈菲, 希尔薇', x: 78, y: 54 },
        { name: '星光圣殿', desc: '隐藏在森林深处的一座古代遗迹，内部设有巨大的星盘。精灵们在此观察星辰的轨迹，以预知世界的重大变动和"气运"的流向。', people: '菲莱拉, 希尔薇', x: 86, y: 30 },
        { name: '银叶城', desc: '精灵族主要的聚居地，所有建筑都与活着的树木共生。城内没有货币，所有物资按需分配，是一个完全自给自足的社群。', people: '无', x: 72, y: 36 },
        { name: '影歌裂谷', desc: '有两处，这一处位于东方精灵之森与人类的交界点，常年被厚重的魔法迷雾遮蔽。这里是精灵、人类与魔族进行秘密交易的"自由港"，也是暗精灵调配烈性毒药的地方。', people: '凯兰崔尔', x: 69, y: 61 },
        { name: '影歌裂谷', desc: '有两处，这一处位于东方精灵之森与魔族的交界点，常年被厚重的魔法迷雾遮蔽。这里是精灵、人类与魔族进行秘密交易的"自由港"，也是暗精灵调配烈性毒药的地方。', people: '凯兰崔尔', x: 65, y: 29 },
        { name: '银叶大图书馆', desc: '位于世界树·伊格德拉修中上层，是精灵族的文化核心与记忆中枢，保存着大量与"气运流动"和"魔力源泉演变"相关的观测记录。', people: '艾拉瑞亚, 菲莱拉, 希尔薇', x: 78, y: 27 },
      ],
    },
    {
      name: '西部翼族山脉',
      children: [
        { name: '风咏之巅', desc: '山脉的主峰，也是翼族族群的精神象征与核心栖息地。所有的翼族都出生并生活在这片与世隔绝的天空之城。', people: '泰瑞尔, 伊卡洛斯, 艾拉, 伊卡, 莉安娜', x: 22, y: 10 },
        { name: '翼族栖息地', desc: '建造在各个山峰悬崖峭壁上的巢穴群落。翼族以家庭为单位居住在这些巢穴中，彼此间保持着疏离的距离。', people: '艾拉', x: 21, y: 22 },
        { name: '试炼之崖', desc: '一处垂直落差巨大的悬崖，是年轻翼族进行飞行、战斗和生存试炼的场所。教官伊卡洛斯会在这里淘汰所有无法适应严酷环境的个体。', people: '伊卡洛斯, 艾拉', x: 25, y: 40 },
        { name: '无声风穴', desc: '山体内部被风蚀出的巨大洞窟，其特殊的结构能完全吸收进入其中的风声，形成绝对的寂静。这里是翼族进行冥想的圣地。', people: '无', x: 28, y: 31 },
        { name: '孤高之巢', desc: '位于一座独立山峰顶端的、最年长翼族泰瑞尔的隐居地。他在这里沉默地观察着族群的存续，是活着的历史。', people: '泰瑞尔', x: 23, y: 30 },
        { name: '云海边界', desc: '翼族领地中海拔最低的区域，靠近下方的云海。一些年轻的翼族（如艾拉）会偷偷飞到这里，试图窥探云层之下的地面世界。', people: '艾拉, 伊卡, 莉安娜', x: 28, y: 55 },
        { name: '风痕断崖', desc: '一段长期暴露在顺风与逆风交汇处的岩壁，表面布满被风刃刻出的条痕。高空风精矿多在此类断崖缝隙中渗出，是翼族内部严控、禁止随意开采的危险区域。', people: '伊卡', x: 26, y: 25 },
      ],
    },
    {
      name: '环大陆之海',
      children: [
        { name: '深海王国·亚特兰', desc: '位于海沟深处的巨大珊瑚城市，是海族文明的中心。城市依靠地热喷口和魔法植物提供光与热，与海面世界完全隔绝。', people: '莉莉丝, 涅瑞伊得, 海琳娜, 乌拉, 海族王室', x: 92, y: 77 },
        { name: '海盗港·利维坦之骨', desc: '由一具远古巨型海兽的骸骨构成的法外之地。无数弯曲的骨骼组成了港口的天然码头和建筑，是大陆上所有通缉犯和灰色交易的聚集地。', people: '无', x: 9, y: 51 },
        { name: '中央大漩涡', desc: '位于海域中心，一个直径超过十公里的永久性巨型漩涡。任何船只一旦靠近都会被卷入深渊，其底部通向何处无人知晓。', people: '无', x: 15, y: 75 },
        { name: '幽灵船海域', desc: '一片终年被浓雾笼罩的海域，磁场异常，所有导航工具都会在此失效。传说无数失事船只的亡魂在此徘徊，攻击一切活物。', people: '无', x: 80, y: 80 },
        { name: '风暴之墙', desc: '环绕大陆外海的一圈永不平息的雷暴带，是无法逾越的世界边界。闪电密集到足以在瞬间将任何船只化为灰烬。', people: '无', x: 95, y: 10 },
        { name: '珊瑚迷宫', desc: '位于浅海区域，由无数巨大的珊瑚礁组成的复杂水下迷宫。这里是各种海洋生物的栖息地，但也因其复杂的地形成为许多船只的墓场。', people: '无', x: 75, y: 82 },
        { name: '珊瑚神殿', desc: '位于深海王国·亚特兰城市最顶端的巨大活体发光珊瑚，是莉莉丝的居所和王国最重要的仪式场所。神殿会随着莉莉丝的歌声而改变颜色和亮度。', people: '莉莉丝', x: 92, y: 81 },
        { name: '王宫', desc: '位于深海王国·亚特兰城市中心，由一整块巨大的深海珍珠母贝构成，是海族王室的居住地和行政中心。', people: '海族王室', x: 91, y: 85 },
        { name: '卫队驻地', desc: '位于深海王国·亚特兰城市屏障边缘，由坚硬的黑珊瑚构成的军事基地，是涅瑞伊得和她的王家卫队的营地。', people: '涅瑞伊得', x: 88, y: 88 },
        { name: '底层区（暗流区）', desc: '位于深海王国·亚特兰城市最下方的昏暗区域，是鲨人等被排斥种族的聚居地，也是雷戈等"野海"居民偶尔出现的地方。', people: '雷戈', x: 85, y: 77 },
      ],
    },
  ];
      ...
      >
       <img
          ...
          <>
            ...
            {Array.from({ length: 11 }).map((_, i) => {
              ...
              return (
                <React.Fragment key={`grid-${i}`}>
                  ...
                  <div
                    key={`v-${i}`}
                    className="absolute top-0 bottom-0 w-px bg-red-500/20 pointer-events-none z-10"
                    style={{ left: `${pos}%` }}
                  />
                  {/* 水平线 */}
                  <div
                    key={`h-${i}`}
                    className="absolute left-0 right-0 h-px bg-red-500/20 pointer-events-none z-10"
                    style={{ top: `${pos}%` }}
                  />
                </React.Fragment>
              );
            ...
            {Array.from({ length: 11 }).map((_, i) => {
              ...
              return (
                <div
                  key={`x-label-${i}`}
                  className="absolute bottom-0 text-[10px] text-red-400/60 font-mono pointer-events-none z-20"
            ...
            {Array.from({ length: 11 }).map((_, i) => {
              ...
              return (
                <div
                  key={`y-label-${i}`}
                  className="absolute left-0 text-[10px] text-red-400/60 font-mono pointer-events-none z-20"
        ...
        {showGrid && locations.map((loc, index) => {
          ...
          const pointShadowColor = locationHasEvent
            ? 'rgba(239, 68, 68, 0.9)'
            : 'rgba(214, 167, 79, 0.9)';
